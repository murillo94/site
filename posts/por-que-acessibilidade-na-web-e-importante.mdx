...
1. O **conteúdo** deve ser toda a informação contida numa página, sendo isso: a informação natural, tal como texto, imagem e áudio ou até código/marcação, que define a estrutura, a forma de apresentação, etc.
